...
if gan_type == 'celeb':
    ...
    PATH_TO_DATA = './models/clown_dcgan/clown_data.pkl'
    PATH_TO_DATA_BACKUP = './models/clown_dcgan/backups/clown_data'
    PATH_TO_LOAD_MODEL_D = './models/clown_dcgan/clown_D_Model'
    PATH_TO_LOAD_MODEL_G = './models/clown_dcgan/clown_G_Model'
    PATH_TO_SAVE_BACKUP_MODEL_D = './models/clown_dcgan/backups/clown_D_Model'
    PATH_TO_SAVE_BACKUP_MODEL_G = './models/clown_dcgan/backups/clown_G_Model'
    PATH_TO_SAVE_MODEL_D = './models/clown_dcgan/clown_D_Model'
    PATH_TO_SAVE_MODEL_G = './models/clown_dcgan/clown_G_Model'
    PATH_TO_IMAGE_LOGS = './clown_gans_images'
    dataroot = r"C:\Users\liamh\Documents\datasets\scaryClowns"
...
lr_g = 0.0002
if gan_type == 'cat' or gan_type == 'clown':
    ...
    if train_model:
        ...
        while epoch <= num_epochs:
            ...
            for i, data in enumerate(dataloader, 0):
                ...
                # on fixed_noise once per 50 epochs
                if (i == len(dataloader)-1) and (epoch % 50 == 0):
                    with torch.no_grad():
            ...
            # Save backups once every 50 epochs
            if epoch % 50 == 0 or gan_type == 'celeb':
